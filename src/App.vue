<template>
  <div id="app">
    <div class="main-header">
      ...
      <div class="main-header-title">Season UI</div>
      <ul class="main-header-nav">
        <li v-for="item in season" :class="{active: active === item}" @click="_handleClick(item)">{{item}}</li>
      </ul>
    </div>
    <div class="main-">
      <div class="main--left">
    ...
    <link rel="stylesheet" href="../lib/css/spring.css">
  </div>
</template>
<script>
    export default {
        ...
        methods: {
            ...
            _handleClick(item) {
                ...
                let href = `../lib/css/${item.toLowerCase()}.css`
